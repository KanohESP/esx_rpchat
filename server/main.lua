...
RegisterCommand('msg', function(source, args, user)
	...
	if GetPlayerName(tonumber(args[1])) then
		...
		TriggerClientEvent('chat:addMessage', player, {args = {"^1[MSG] ^7de ^2"..GetPlayerName(source).. "^1 [" .. source .. "] : ^7" ..table.concat(args, " ")}, color = {132, 214, 110}})
		TriggerClientEvent('chat:addMessage', source, {args = {"^1[MSG] ^7a  ^2"..GetPlayerName(player).. "^1 [" .. player .. "] ^3: ^0" ..table.concat(args, " ")}, color = {255, 153, 0}})
...
RegisterCommand('ayuda', function(source, args, rawCommand)
	...
	TriggerClientEvent('chat:addMessage', -1, { args = { _U('ayuda_prefix', '['..source..'] '), args }, color = { 255, 81, 39 } })
...
RegisterCommand('id', function(source, args, rawCommand)
	...
	TriggerClientEvent('chat:addMessage', -1, { args = { _U('id_prefix', '['..source..'] '), args }, color = { 161, 48, 255 } })
	--print(('%s: %s'):format(name, args))
end, false)
